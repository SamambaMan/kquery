...
class Ui_connections(object):
    def setupUi(self, connections):
        ...
        self.connectionslist = QtWidgets.QTableView(connections)
        self.connectionslist.setObjectName("connectionslist")
        self.connectionslist.horizontalHeader().setVisible(False)
        self.connectionslist.verticalHeader().setVisible(False)
